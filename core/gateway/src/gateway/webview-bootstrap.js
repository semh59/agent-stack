...
exports.WebviewBootGate = void 0;
exports.resolveWebviewAssets = resolveWebviewAssets;
 ...
 */
function resolveWebviewAssets(distPath, assetsPath) {
    const notes = [];
 ...
 */
class WebviewBootGate {
    _timeoutMs;
    queue = [];
    _ready = false;
    _sendFn = null;
    constructor(_timeoutMs = 400) {
    ...
    reset() { this._ready = false; this.queue = []; this._sendFn = null; }
}
exports.WebviewBootGate = WebviewBootGate;
//# sourceMappingURL=webview-bootstrap.js.map