...
exports.isGemini25Model = isGemini25Model;
exports.isImageGenerationModel = isImageGenerationModel;
exports.buildGemini3ThinkingConfig = buildGemini3ThinkingConfig;
exports.buildGemini25ThinkingConfig = buildGemini25ThinkingConfig;
exports.buildImageGenerationConfig = buildImageGenerationConfig;
exports.normalizeGeminiTools = normalizeGeminiTools;
exports.applyGeminiTransforms = applyGeminiTransforms;
exports.wrapToolsAsFunctionDeclarations = wrapToolsAsFunctionDeclarations;
/**
 ...
 * Alloy uses strict protobuf-backed JSON validation.
 */
 ...
 * - Alloy_IMAGE_ASPECT_RATIO: Aspect ratio (e.g., "16:9", "4:3")
 *
 * Defaults to 1:1 aspect ratio if not specified.
 *
 * Note: Resolution setting is not currently supported by the Alloy API.
 */
function buildImageGenerationConfig() {
    // Read aspect ratio from environment or default to 1:1
    const aspectRatio = process.env.Alloy_IMAGE_ASPECT_RATIO || "1:1";
...
function applyGeminiTransforms(payload, options) {
    ...
    // Alloy strict protobuf validation rejects wrapper-level 'parameters' field
