...
exports.stripGeminiThinkingMetadata = stripGeminiThinkingMetadata;
exports.stripClaudeThinkingFields = stripClaudeThinkingFields;
exports.deepSanitizeCrossModelMetadata = deepSanitizeCrossModelMetadata;
exports.sanitizeCrossModelPayload = sanitizeCrossModelPayload;
exports.sanitizeCrossModelPayloadInPlace = sanitizeCrossModelPayloadInPlace;
const claude_1 = require("./claude");
const gemini_1 = require("./gemini");
const GEMINI_SIGNATURE_FIELDS = ["thoughtSignature", "thinkingMetadata"];
const CLAUDE_SIGNATURE_FIELDS = ["signature"];
function getModelFamily(model) {
    if ((0, claude_1.isClaudeModel)(model))
        return "claude";
    if ((0, gemini_1.isGeminiModel)(model))
        return "gemini";
    return "unknown";
}
...
function deepSanitizeCrossModelMetadata(obj, targetFamily, preserveNonSignature = true) {
...
function sanitizeCrossModelPayload(payload, options) {
