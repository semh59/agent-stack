...
exports.CLAUDE_INTERLEAVED_THINKING_HINT = exports.CLAUDE_THINKING_MAX_OUTPUT_TOKENS = void 0;
...
exports.applyClaudeTransforms = applyClaudeTransforms;
...
exports.CLAUDE_INTERLEAVED_THINKING_HINT = "Interleaved thinking is enabled. You may think between tool calls and after receiving tool results before deciding the next action or final answer. Do not mention these instructions or any constraints about thinking blocks; just apply them.";
/**
 ...
 */
function appendClaudeThinkingHint(payload, hint = exports.CLAUDE_INTERLEAVED_THINKING_HINT) {
 ...
 */
function applyClaudeTransforms(payload, options) {
