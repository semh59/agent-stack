...
exports.createSignatureCache = exports.SignatureCache = void 0;
exports.resolveCachedAuth = resolveCachedAuth;
exports.storeCachedAuth = storeCachedAuth;
exports.clearCachedAuth = clearCachedAuth;
exports.initDiskSignatureCache = initDiskSignatureCache;
exports.getDiskSignatureCache = getDiskSignatureCache;
exports.cacheSignature = cacheSignature;
exports.getCachedSignature = getCachedSignature;
...
function resolveCachedAuth(auth) {
    ...
    if (!(0, auth_1.accessTokenExpired)(cached)) {
        return cached;
    }
    authCache.set(key, auth);
    return auth;
...
function initDiskSignatureCache(config) {
    diskCache = (0, signature_cache_1.createSignatureCache)(config);
    return diskCache;
}
/**
 * Get the disk cache instance (for testing/debugging).
 */
function getDiskSignatureCache() {
    return diskCache;
}
/**
 * Normalizes thinking text for stable hashing.
 * Strips leading/trailing whitespace, collapses multiple internal spaces,
 * and normalizes all newline variants to \n.
 */
 ...
 * Applies forensic normalization before hashing.
 */
function hashText(text) {
    const normalized = normalizeThinkingText(text);
    return (0, node_crypto_1.createHash)("sha256").update(normalized, "utf8").digest("hex").slice(0, SIGNATURE_TEXT_HASH_HEX_LEN);
}
/**
...
var signature_cache_2 = require("./cache/signature-cache");
Object.defineProperty(exports, "SignatureCache", { enumerable: true, get: function () { return signature_cache_2.SignatureCache; } });
Object.defineProperty(exports, "createSignatureCache", { enumerable: true, get: function () { return signature_cache_2.createSignatureCache; } });
