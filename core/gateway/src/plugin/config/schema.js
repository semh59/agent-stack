"use strict";
/**
 * Configuration schema for alloy-ai plugin.
 *
 * Config file locations (in priority order, highest wins):
 * - Project: .Alloy/Alloy.json
 * - User: ~/.config/Alloy/Alloy.json (Linux/Mac)
 *         %APPDATA%\Alloy\Alloy.json (Windows)
 *
 * Environment variables always override config file values.
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.DEFAULT_CONFIG = exports.AlloyGatewayConfigSchema = exports.SignatureCacheConfigSchema = exports.SchedulingModeSchema = exports.ToastScopeSchema = exports.AccountSelectionStrategySchema = void 0;
 ...
 */
exports.AccountSelectionStrategySchema = zod_1.z.enum(['sticky', 'round-robin', 'hybrid']);
/**
 ...
 */
exports.ToastScopeSchema = zod_1.z.enum(['root_only', 'all']);
/**
 ...
 */
exports.SchedulingModeSchema = zod_1.z.enum(['cache_first', 'balance', 'performance_first']);
/**
 * Signature cache configuration for persisting thinking block signatures to disk.
 */
exports.SignatureCacheConfigSchema = zod_1.z.object({
    /** Enable disk caching of signatures (default: true) */
    enabled: zod_1.z.boolean().default(true),
    /** In-memory TTL in seconds (default: 3600 = 1 hour) */
    memory_ttl_seconds: zod_1.z.number().min(60).max(86400).default(3600),
    /** Disk TTL in seconds (default: 172800 = 48 hours) */
    disk_ttl_seconds: zod_1.z.number().min(3600).max(604800).default(172800),
    /** Background write interval in seconds (default: 60) */
    write_interval_seconds: zod_1.z.number().min(10).max(600).default(60),
});
/**
 * Main configuration schema for the Alloy OAuth plugin.
 */
exports.AlloyGatewayConfigSchema = zod_1.z.object({
    alloy: zod_1.z.object({
     ...
     * Env override: Alloy_ALLOY_QUIET=1
     * @default false
     */
    quiet_mode: zod_1.z.boolean().default(false),
    /**
     ...
     * Env override: Alloy_ALLOY_TOAST_SCOPE=all
     * @default "root_only"
     */
    toast_scope: exports.ToastScopeSchema.default('root_only'),
    /**
     * Enable debug logging to file.
     * Env override: Alloy_ALLOY_DEBUG=1
     * @default false
     */
    debug: zod_1.z.boolean().default(false),
    /**
     * Custom directory for debug logs.
     * Env override: Alloy_ALLOY_LOG_DIR=/path/to/logs
     * @default OS-specific config dir + "/Alloy-logs"
     */
     ...
     *
     * Env override: Alloy_ALLOY_KEEP_THINKING=1
     * @default false
     */
    keep_thinking: zod_1.z.boolean().default(false),
    // =========================================================================
    // Session Recovery
    // =========================================================================
    /**
     ...
     * @default true
     */
    session_recovery: zod_1.z.boolean().default(true),
    /**
     ...
     * @default false
     */
    auto_resume: zod_1.z.boolean().default(false),
    /**
     ...
     * @default "continue"
     */
    resume_text: zod_1.z.string().default("continue"),
    // =========================================================================
    // Signature Caching
    // =========================================================================
    /**
     ...
     */
    signature_cache: exports.SignatureCacheConfigSchema.optional(),
    // =========================================================================
    // Empty Response Retry (ported from LLM-API-Key-Proxy)
    // =========================================================================
    /**
     * Maximum retry attempts when Alloy returns an empty response.
     * Empty responses occur when no candidates/choices are returned.
     *
     * @default 4
     */
    empty_response_max_attempts: zod_1.z.number().min(1).max(10).default(4),
    /**
     * Delay in milliseconds between empty response retries.
     *
     * @default 2000
     */
    empty_response_retry_delay_ms: zod_1.z.number().min(500).max(10000).default(2000),
    // =========================================================================
     ...
     * @default true
     */
    tool_id_recovery: zod_1.z.boolean().default(true),
    // =========================================================================
     ...
     * @default true
     */
    claude_tool_hardening: zod_1.z.boolean().default(true),
    // =========================================================================
     ...
     * @default true
     */
    proactive_token_refresh: zod_1.z.boolean().default(true),
    /**
     ...
     * @default 1800
     */
    proactive_refresh_buffer_seconds: zod_1.z.number().min(60).max(7200).default(1800),
    /**
     ...
     * @default 300
     */
    proactive_refresh_check_interval_seconds: zod_1.z.number().min(30).max(1800).default(300),
    // =========================================================================
    // Rate Limiting
    // =========================================================================
    /**
     ...
     */
    max_rate_limit_wait_seconds: zod_1.z.number().min(0).max(3600).default(300),
    /**
     * Enable quota fallback for Gemini models.
     * When the preferred quota (gemini-cli or Alloy) is exhausted,
     ...
     * Explicit suffixes like `:Alloy` or `:gemini-cli` always use
     * that specific quota and switch accounts if exhausted.
     *
     * @default false
     */
    quota_fallback: zod_1.z.boolean().default(false),
    /**
     * Prefer gemini-cli routing before Alloy for Gemini models.
     *
     * When false (default): Alloy is tried first, then gemini-cli.
     * When true: gemini-cli is tried first, then Alloy.
     *
     * @default false
     */
    cli_first: zod_1.z.boolean().default(false),
    /**
     * Strategy for selecting accounts when making requests.
     * Env override: Alloy_ALLOY_ACCOUNT_SELECTION_STRATEGY
     * @default "hybrid"
     */
    account_selection_strategy: exports.AccountSelectionStrategySchema.default('hybrid'),
    /**
     ...
     *
     * Env override: Alloy_ALLOY_PID_OFFSET_ENABLED=1
     * @default false
     */
    pid_offset_enabled: zod_1.z.boolean().default(false),
    /**
       ...
       * @default true
       */
    switch_on_first_rate_limit: zod_1.z.boolean().default(true),
    /**
     * Scheduling mode for rate limit behavior.
     *
     * - `cache_first`: Wait for same account to recover (preserves prompt cache). Default.
     ...
     * - `performance_first`: Round-robin distribution for maximum throughput.
     *
     * Env override: Alloy_ALLOY_SCHEDULING_MODE
     * @default "cache_first"
     */
    scheduling_mode: exports.SchedulingModeSchema.default('cache_first'),
    /**
     ...
     * @default 60
     */
    max_cache_first_wait_seconds: zod_1.z.number().min(5).max(300).default(60),
    /**
     ...
     * @default 3600 (1 hour)
     */
    failure_ttl_seconds: zod_1.z.number().min(60).max(7200).default(3600),
    /**
     ...
     * @default 60
     */
    default_retry_after_seconds: zod_1.z.number().min(1).max(300).default(60),
    /**
     ...
     * @default 60
     */
    max_backoff_seconds: zod_1.z.number().min(5).max(300).default(60),
    /**
     ...
     * @default 0
     */
    request_jitter_max_ms: zod_1.z.number().min(0).max(5000).default(0),
    /**
     ...
     * @default 90
     */
    soft_quota_threshold_percent: zod_1.z.number().min(1).max(100).default(90),
    /**
     ...
     * @default 15
     */
    quota_refresh_interval_minutes: zod_1.z.number().min(0).max(60).default(15),
    /**
     ...
     * @default "auto"
     */
    soft_quota_cache_ttl_minutes: zod_1.z.union([
        zod_1.z.literal("auto"),
        zod_1.z.number().min(1).max(120)
    ]).default("auto"),
    // =========================================================================
    // Health Score (used by hybrid strategy)
    // =========================================================================
    health_score: zod_1.z.object({
        initial: zod_1.z.number().min(0).max(100).default(70),
        success_reward: zod_1.z.number().min(0).max(10).default(1),
        rate_limit_penalty: zod_1.z.number().min(-50).max(0).default(-10),
        failure_penalty: zod_1.z.number().min(-100).max(0).default(-20),
        recovery_rate_per_hour: zod_1.z.number().min(0).max(20).default(2),
        min_usable: zod_1.z.number().min(0).max(100).default(50),
        max_score: zod_1.z.number().min(50).max(100).default(100),
    }).optional(),
    // =========================================================================
    // Token Bucket (for hybrid strategy)
    // =========================================================================
    token_bucket: zod_1.z.object({
        max_tokens: zod_1.z.number().min(1).max(1000).default(50),
        regeneration_rate_per_minute: zod_1.z.number().min(0.1).max(60).default(6),
        initial_tokens: zod_1.z.number().min(1).max(1000).default(50),
    }).optional(),
    // =========================================================================
    // Auto-Update
    // =========================================================================
     ...
     * @default true
     */
    auto_update: zod_1.z.boolean().default(true),
    /**
     * Circuit breaker failure threshold (number of consecutive failures per endpoint).
     * @default 5
     */
    circuit_breaker_threshold: zod_1.z.number().min(1).max(20).default(5),
    /**
     * Circuit breaker reset timeout in seconds.
     * @default 30
     */
    circuit_breaker_timeout_seconds: zod_1.z.number().min(5).max(300).default(30),
});
/**
