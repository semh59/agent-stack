...
exports.CAPACITY_BACKOFF_TIERS_MS = void 0;
exports.getCapacityBackoffDelay = getCapacityBackoffDelay;
exports.retryAfterMsFromResponse = retryAfterMsFromResponse;
exports.parseDurationToMs = parseDurationToMs;
exports.CAPACITY_BACKOFF_TIERS_MS = [5000, 10000, 20000, 30000, 60000];
/**
 * Get the next capacity backoff delay based on consecutive failures.
 */
function getCapacityBackoffDelay(consecutiveFailures) {
    const index = Math.min(consecutiveFailures, exports.CAPACITY_BACKOFF_TIERS_MS.length - 1);
    return exports.CAPACITY_BACKOFF_TIERS_MS[Math.max(0, index)] ?? 5000;
}
/**
