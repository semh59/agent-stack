 ...
 */
export const ALLOY_SCOPES: readonly string[] = [
 ...
 */
export const ALLOY_ENDPOINT_DAILY = "https://daily-cloudcode-pa.sandbox.googleapis.com";
export const ALLOY_ENDPOINT_AUTOPUSH = "https://autopush-cloudcode-pa.sandbox.googleapis.com";
export const ALLOY_ENDPOINT_PROD = "https://cloudcode-pa.googleapis.com";
 ...
 */
export const ALLOY_ENDPOINT_FALLBACKS = [
  ALLOY_ENDPOINT_DAILY,
  ALLOY_ENDPOINT_AUTOPUSH,
  ALLOY_ENDPOINT_PROD,
] as const;
 ...
 */
export const ALLOY_LOAD_ENDPOINTS = [
  ALLOY_ENDPOINT_PROD,
  ALLOY_ENDPOINT_DAILY,
  ALLOY_ENDPOINT_AUTOPUSH,
] as const;
 ...
 */
export const ALLOY_ENDPOINT = ALLOY_ENDPOINT_DAILY;
 ...
 */
export const GEMINI_CLI_ENDPOINT = ALLOY_ENDPOINT_PROD;

/**
 * Hardcoded project id used when Alloy does not return one (e.g., business/workspace accounts).
 */
export const ALLOY_DEFAULT_PROJECT_ID = "rising-fact-p41fc";
 ...
 */
export const ALLOY_HEADERS = {
  "User-Agent": `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Alloy/${ALLOY_VERSION} Chrome/138.0.7204.235 Electron/37.3.1 Safari/537.36`,
...
const ALLOY_PLATFORMS = ["windows/amd64", "darwin/arm64", "linux/amd64", "darwin/amd64", "linux/arm64"] as const;

// Derive user agents from version (keeps them in sync automatically)
const ALLOY_USER_AGENTS = ALLOY_PLATFORMS.map(platform => `Alloy/${ALLOY_VERSION} ${platform}`);
...
export const ALLOY_SYSTEM_INSTRUCTION = `You are Alloy AI, a powerful agentic AI coding assistant designed by the Google DeepMind team working on Advanced Agentic Coding.
