...
exports.MemoryBankReconciler = void 0;
...
`.trim();
    ...
    async syncProductContext(state) {
...
`.trim();
    ...
    async syncSystemPatterns(state) {
...
`.trim();
     ...
     */
    async atomicSync(filePath, controlledContent) {
        let existing = null;
        try {
...
exports.MemoryBankReconciler = MemoryBankReconciler;
//# sourceMappingURL=MemoryBankReconciler.js.map