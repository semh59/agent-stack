...
interface ModelTest {
  model: string;
  category: "gemini-cli" | "alloy-gemini" | "alloy-claude";
}
...
const MODELS: ModelTest[] = [
  ...
  // Alloy AI Gemini
  { model: "google/alloy-gemini-3-pro-low", category: "alloy-gemini" },
  { model: "google/alloy-gemini-3-pro-high", category: "alloy-gemini" },
  { model: "google/alloy-gemini-3-flash", category: "alloy-gemini" },

  // Alloy AI Claude
  { model: "google/alloy-claude-sonnet-4-5", category: "alloy-claude" },
  { model: "google/alloy-claude-sonnet-4-5-thinking-low", category: "alloy-claude" },
  { model: "google/alloy-claude-sonnet-4-5-thinking-medium", category: "alloy-claude" },
  { model: "google/alloy-claude-sonnet-4-5-thinking-high", category: "alloy-claude" },
  { model: "google/alloy-claude-opus-4-5-thinking-low", category: "alloy-claude" },
  { model: "google/alloy-claude-opus-4-5-thinking-medium", category: "alloy-claude" },
  { model: "google/alloy-claude-opus-4-5-thinking-high", category: "alloy-claude" },
  { model: "google/alloy-claude-opus-4-6-thinking-low", category: "alloy-claude" },
  { model: "google/alloy-claude-opus-4-6-thinking-medium", category: "alloy-claude" },
  { model: "google/alloy-claude-opus-4-6-thinking-high", category: "alloy-claude" },
];
...
async function testModel(model: string, timeoutMs: number): Promise<TestResult> {
  ...
  return new Promise((resolve) => {
    const proc = spawn("Alloy", ["run", TEST_PROMPT, "--model", model], {
...
Options:
  ...
  --category <cat>     Test by category (gemini-cli, alloy-gemini, alloy-claude)
...
Examples:
  ...
  npx tsx script/test-models.ts --category alloy-claude
`);
}
