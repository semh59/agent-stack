"""
Integration tests — require Ollama running at AI_STACK_OLLAMA_URL.

Mark: @pytest.mark.integration
Run:  pytest tests/integration/ -v -m integration

In Docker:
    docker compose run --rm ai-stack-mcp pytest tests/integration/ -v -m integration
"""
...
OLLAMA_URL = os.environ.get("AI_STACK_OLLAMA_URL", "http://localhost:11434")
