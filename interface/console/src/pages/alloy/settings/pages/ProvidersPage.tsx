...
const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    id: "sambanova",
    label: "SambaNova",
    blurb: "SambaNova Cloud — next-gen Llama 3 execution at edge speeds.",
    kind: "cloud",
  ...
  },
  {
    id: "together",
    label: "Together AI",
    blurb: "Ultra-fast open source models (Llama 3, Qwen, DeepSeek).",
    kind: "cloud",
  ...
  },
  {
    id: "fireworks",
    label: "Fireworks",
    blurb: "Optimized model hosting for developers.",
    kind: "cloud",
