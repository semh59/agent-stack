/**
 * Sovereign chat slice — conversation list + active session + streaming state.
 *
...
export interface SovereignChatSlice {
...
export const createSovereignChatSlice: StateCreator<
  SovereignChatSlice,
  [],
  [],
  SovereignChatSlice
