...
export const log = {
  debug: (...args: any[]) => console.debug('[Antigravity:Debug]', ...args),
  info: (...args: any[]) => console.info('[Antigravity:Info]', ...args),
  warn: (...args: any[]) => console.warn('[Antigravity:Warn]', ...args),
  error: (...args: any[]) => console.error('[Antigravity:Error]', ...args),
};
...
export function getCliFirst(config: AntigravityConfig): boolean {
  ...
  return !!(config as any).antigravity?.cliFirst;
}
