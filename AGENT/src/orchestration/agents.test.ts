...
describe('Agent Definitions', () => {
  ...
  describe('Sovereignty: outputValidation', () => {
  ...
  describe('Sovereignty: haltConditions', () => {
  ...
  describe('Sovereignty: verificationCommands', () => {
  ...
  describe('Sovereignty: scope boundaries', () => {
