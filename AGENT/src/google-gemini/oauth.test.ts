...
vi.mock('../constants', () => ({
  SOVEREIGN_CLIENT_ID: 'test-client-id',
  SOVEREIGN_CLIENT_SECRET: 'test-client-secret',
  SOVEREIGN_REDIRECT_URI: 'http://localhost:3000/callback',
  SOVEREIGN_SCOPES: ['scope1', 'scope2'],
  SOVEREIGN_ENDPOINT_FALLBACKS: [],
  SOVEREIGN_LOAD_ENDPOINTS: ['https://api.example.com'],
  SOVEREIGN_HEADERS: { 'Client-Metadata': 'test' },
