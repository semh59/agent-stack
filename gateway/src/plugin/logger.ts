 ...
 * 2. OPENCODE_ALLOY_CONSOLE_LOG=1 is set (logs to console)
 *
 * Ported from opencode-google-Alloy-auth/src/plugin/logger.ts
 */
...
const ENV_CONSOLE_LOG = "OPENCODE_ALLOY_CONSOLE_LOG";
 ...
 * Only outputs when OPENCODE_ALLOY_CONSOLE_LOG=1 is set.
 *
 ...
 */
export function printAlloyConsole(
  level: LogLevel,
  message: string,
  extra?: unknown,
): void {
