...
function parseSearchResponse(data: AlloySearchResponse): SearchResult {
...
export async function executeSearch(
  ...
  const url = `${ALLOY_ENDPOINT}/v1internal:generateContent`;
  ...
  try {
    ...
    const data = (await response.json()) as AlloySearchResponse;
