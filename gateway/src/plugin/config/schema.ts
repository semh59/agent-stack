 ...
 * - Project: .opencode/Alloy.json
 * - User: ~/.config/opencode/Alloy.json (Linux/Mac)
 *         %APPDATA%\opencode\Alloy.json (Windows)
 * 
 ...
 */
export const AlloyGatewayConfigSchema = z.object({
  alloy: z.object({
   ...
   * Env override: OPENCODE_ALLOY_QUIET=1
   * @default false
   */
   ...
   * Env override: OPENCODE_ALLOY_TOAST_SCOPE=all
   * @default "root_only"
   */
   ...
   * Env override: OPENCODE_ALLOY_DEBUG=1
   * @default false
   */
   ...
   * Env override: OPENCODE_ALLOY_LOG_DIR=/path/to/logs
   ...
   * 
   * Env override: OPENCODE_ALLOY_KEEP_THINKING=1
   * @default false
   */
   ...
   * Env override: OPENCODE_ALLOY_ACCOUNT_SELECTION_STRATEGY
   * @default "hybrid"
   */
   ...
   * 
   * Env override: OPENCODE_ALLOY_PID_OFFSET_ENABLED=1
   * @default false
   */
  pid_offset_enabled: z.boolean().default(false),
   ...
   /**
     ...
     * - `performance_first`: Round-robin distribution for maximum throughput.
     * 
     * Env override: OPENCODE_ALLOY_SCHEDULING_MODE
     * @default "cache_first"
     */
   ...
   * @default 5
   */
  circuit_breaker_threshold: z.number().min(1).max(20).default(5),

  /**
   * Circuit breaker reset timeout in seconds.
   * @default 30
   */
  circuit_breaker_timeout_seconds: z.number().min(5).max(300).default(30),

});

export type AlloyGatewayConfig = z.infer<typeof AlloyGatewayConfigSchema>;
export type SignatureCacheConfig = z.infer<typeof SignatureCacheConfigSchema>;

/**
 * Default configuration values.
 */
export const DEFAULT_CONFIG: AlloyGatewayConfig = {
  quiet_mode: false,
