...
// â”€â”€ cleanJSONSchemaForAlloy â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

describe("cleanJSONSchemaForAlloy", () => {
  it("should return null/undefined/primatives unchanged", () => {
    expect(cleanJSONSchemaForAlloy(null)).toBeNull();
    expect(cleanJSONSchemaForAlloy(undefined)).toBeUndefined();
    expect(cleanJSONSchemaForAlloy("hello")).toBe("hello");
    expect(cleanJSONSchemaForAlloy(42)).toBe(42);
  });
