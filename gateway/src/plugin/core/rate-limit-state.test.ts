...
describe("headerStyleToQuotaKey", () => {
  it("should return claude for claude family", () => {
    expect(headerStyleToQuotaKey("Alloy", "claude")).toBe("claude");
  });

  it("should return gemini-Alloy for Alloy style", () => {
    expect(headerStyleToQuotaKey("Alloy", "gemini")).toBe("gemini-Alloy");
  });
