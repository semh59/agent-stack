...
describe("refreshAccessToken", () => {
  ...
  it("throws AlloyTokenRefreshError on non-ok response", async () => {
  ...
  it("returns undefined on network error (not AlloyTokenRefreshError)", async () => {
    const auth = makeOAuthAuth("1//refresh|project");
...
describe("AlloyTokenRefreshError", () => {
  it("has correct properties", () => {
    const error = new AlloyTokenRefreshError({
    ...
    expect(error.name).toBe("AlloyTokenRefreshError");
