 ...
 *
 * Examples:
 * - "gemini-2.5-flash" â†’ { quotaPreference: "Alloy" }
 * - "gemini-3-pro-preview" â†’ { quotaPreference: "Alloy" }
 * - "Alloy-gemini-3-pro-high" â†’ { quotaPreference: "Alloy", explicitQuota: true }
 * - "claude-sonnet-4-5-thinking-medium" â†’ { quotaPreference: "Alloy" }
 *
...
export function resolveModelWithTier(requestedModel: string, options: ModelResolverOptions = {}): ResolvedModel {
  ...
  const quotaPreference = preferGeminiCli ? "gemini-cli" as const : "Alloy" as const;
 ...
 * - gemini-3-flash-preview (gemini-cli) â†’ gemini-3-flash (Alloy)
 * - gemini-3-pro-preview (gemini-cli) â†’ gemini-3-pro-low (Alloy)
 * - gemini-3-flash (Alloy) â†’ gemini-3-flash-preview (gemini-cli)
 */
export function resolveModelForHeaderStyle(
  requestedModel: string,
  headerStyle: "Alloy" | "gemini-cli"
): ResolvedModel {
