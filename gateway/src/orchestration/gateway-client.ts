...
export class AlloyGatewayClient {
   ...
   */
  public static fromToken(accessToken: string, email: string = 'default', realManager?: AccountManager): AlloyGatewayClient {
  ...
  public async runThinkingWarmup(
    ...
    log.info(`[Alloy AI] Running thinking warmup for project: ${projectId}`);
