/**
 * Alloy secret encryption â€” AES-256-GCM envelope.
 *
 ...
 * `ALLOY_MASTER_KEY` environment variable.
 *
 *   master_key (32 bytes, base64)  â†  ALLOY_MASTER_KEY env var
 ...
 *
 * We ship NO default key. Booting the gateway without `ALLOY_MASTER_KEY`
...
const ENV_VAR = "ALLOY_MASTER_KEY";
