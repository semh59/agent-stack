    ...
    if (this.state.hasError) {
      return (
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="max-w-sm w-full bg-[var(--color-alloy-surface)] border border-red-900/30 rounded-xl p-6 shadow-lg">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[var(--color-alloy-text-sec)] text-xs mb-4">
                An error occurred while loading this page. Other pages are still functional.
              </p>
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[var(--color-alloy-accent)] hover:bg-[var(--color-alloy-accent)]/80 text-white px-5 py-2.5 rounded-lg font-ui text-sm transition-all w-full"
              >
