...
```
┌─────────────────────────────────────────────────────────────────┐
│  OpenCode ──▶ Plugin ──▶ Alloy AI API ──▶ Claude/Gemini      │
│     │           │              │                   │            │
│     │           │              │                   └─ Model     │
...
| Variable | Purpose |
|----------|---------|
| `OPENCODE_ALLOY_DEBUG` | `1` or `2` for debug logging |
| `OPENCODE_ALLOY_QUIET` | Suppress toast notifications |

### Config File

Location: `~/.config/opencode/alloy.json`
...
```bash
export OPENCODE_ALLOY_DEBUG=2  # Verbose
```

### Log Location

`~/.config/opencode/alloy-logs/`
