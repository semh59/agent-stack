...
def tmp_settings(tmp_path):
    ...
    import os
    os.environ["AI_STACK_DATA_DIR"] = str(tmp_path)
    os.environ["AI_STACK_OLLAMA_URL"] = "http://localhost:11434"
    os.environ["AI_STACK_OPENROUTER_API_KEY"] = ""
    ...
    # Cleanup env
    for key in ["AI_STACK_DATA_DIR", "AI_STACK_OLLAMA_URL", "AI_STACK_OPENROUTER_API_KEY"]:
